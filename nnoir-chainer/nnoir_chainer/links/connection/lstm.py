...
def to_nnoir_node(self, inputs, outputs):
    ...
    upward_functions_linear_b = encode_ndarray(self.upward.b.data) if (hasattr(self, "b") and self.upward.b is not None) else None
    ...
    lateral_functions_linear_b = encode_ndarray(self.lateral.b.data) if (hasattr(self, "b") and self.lateral.b is not None) else None
