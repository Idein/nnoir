...
def test_concat_00():
    class ConcatTester(Base):
        def create_onnx(self) -> onnx.ModelProto:
            ...
            inputs = [info("v0", TensorProto.FLOAT, (1, 2, 4, 5)), info("v1", TensorProto.FLOAT, (1, 2, 4, 5))]
...
def test_concat_01():
    class ConcatTester(Base):
        def create_onnx(self) -> onnx.ModelProto:
            ...
            inputs = [info("v0", TensorProto.FLOAT, (1, 2, 9, 5)), info(
                "v1", TensorProto.FLOAT, (1, 2, 4, 5)), info("v2", TensorProto.FLOAT, (1, 2, 7, 5))]
...
def test_concat_02():
    ...
    class ConcatTester(Base):
        def create_onnx(self) -> onnx.ModelProto:
            ...
            inputs = [info("v0", TensorProto.FLOAT, (1, 2, 9, 5)), info("v1", TensorProto.FLOAT, (1, 2, 4, 5))]
