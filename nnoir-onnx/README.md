...
* [Mul](https://github.com/onnx/onnx/blob/master/docs/Operators.md#Mul)
    * for opset <= 6 without `axis` specification and for opset >= 7, if only one input is
[Constant](https://github.com/onnx/onnx/blob/master/docs/Operators.md#Constant),
 supports only [unidirectional broadcast](https://github.com/onnx/onnx/blob/master/docs/Broadcasting.md#unidirectional-broadcasting) on the constant input
